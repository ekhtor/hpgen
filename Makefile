#############################################################################
# Makefile for building: diccionarioGen
# Generated by qmake (2.01a) (Qt 4.7.1) on: mar mar 15 18:23:52 2011
# Project:  diccionarioGen.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -spec /usr/lib/qt4/mkspecs/linux-g++ CONFIG+=debug QMLJSDEBUGGER_PATH=/usr/share/qtcreator/qml/qmljsdebugger -o Makefile diccionarioGen.pro
#############################################################################
...
DIST          = /usr/lib/qt4/mkspecs/common/g++-multilib.conf \
		...
		diccionarioGen.pro
QMAKE_TARGET  = diccionarioGen
DESTDIR       = 
TARGET        = diccionarioGen
...
Makefile: diccionarioGen.pro  /usr/lib/qt4/mkspecs/linux-g++/qmake.conf /usr/lib/qt4/mkspecs/common/g++-multilib.conf \
		/usr/lib/qt4/mkspecs/common/unix.conf \
		/usr/lib/qt4/mkspecs/common/linux.conf \
		/usr/lib/qt4/mkspecs/qconfig.pri \
		/usr/lib/qt4/mkspecs/modules/qt_webkit_version.pri \
		...
		/usr/lib/qt4/mkspecs/features/lex.prf \
		/usr/lib/qt4/mkspecs/features/include_source_dir.prf
	$(QMAKE) -spec /usr/lib/qt4/mkspecs/linux-g++ CONFIG+=debug QMLJSDEBUGGER_PATH=/usr/share/qtcreator/qml/qmljsdebugger -o Makefile diccionarioGen.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/diccionarioGen1.0.0 || $(MKDIR) .tmp/diccionarioGen1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/diccionarioGen1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/diccionarioGen1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/diccionarioGen1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/diccionarioGen1.0.0/ && (cd `dirname .tmp/diccionarioGen1.0.0` && $(TAR) diccionarioGen1.0.0.tar diccionarioGen1.0.0 && $(COMPRESS) diccionarioGen1.0.0.tar) && $(MOVE) `dirname .tmp/diccionarioGen1.0.0`/diccionarioGen1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/diccionarioGen1.0.0
